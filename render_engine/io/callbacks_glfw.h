...
* We want to send input events to the InputContext of the relevant RenderEngine
...
public:
	...
	*/
	static void registerWindow(GLFWwindow* wnd, RenderEngine* engine);
...
private:
	...
	* Looks up a mapping.
	*/
	static RenderEngine* lookup_engine(GLFWwindow* wnd);
