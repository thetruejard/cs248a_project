...
/*
* CppGameEngine is the core class for the game engine.
...
* See CppGameEngine.cpp for the implementation of this class (i.e. function definitions).
*/
class CppGameEngine {
public:

	CppGameEngine();
	CppGameEngine(Graphics::Backend backend);
	CppGameEngine(const CppGameEngine&) = delete;
	CppGameEngine(CppGameEngine&&) = delete;
	CppGameEngine& operator=(const CppGameEngine&) = delete;
	CppGameEngine& operator=(CppGameEngine&&) = delete;
	~CppGameEngine();
