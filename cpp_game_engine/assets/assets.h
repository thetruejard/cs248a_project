...
public:
	...
	static Ref<GameObject> importObject(CppGameEngine& engine, std::filesystem::path path);

	static Ref<Texture> importTexture(CppGameEngine& engine, std::filesystem::path path);
